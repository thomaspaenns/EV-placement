...
#     48010: 0
# }
# stations = model.get_optimal(1000000, stations_for_model)
# print(stations)
# coverage = model.get_coverage()
# print(coverage)
# sim.simulate(stations, coverage)
# sim.get_coverage()
# sim.get_util()
# sim.get_wait_times()
...
def compute_optimal_solution_and_run_simulation(n_clicks, budget_data, stored_clicked_lhrs, toggle_clicks, selected_year_str):
    if n_clicks > 0:
        ...
        if budget is not None:
            ...
            return "Please enter a valid budget."
    return "Click 'Compute Optimal Solution' to start."
